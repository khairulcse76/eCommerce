...
class MyTextTheme{
  ...
  static TextTheme lightTextTheme= TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0,fontWeight: FontWeight.w100, color: Colors.black),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.6)),
    labelSmall: const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w500, color: Colors.black.withOpacity(0.4)),

    button: const TextStyle().copyWith(fontSize: 18.0,fontWeight: FontWeight.normal, color: Colors.black),
  ...
  static TextTheme darkTextTheme= TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0,fontWeight: FontWeight.w100, color: Colors.white),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.normal, color: Colors.white.withOpacity(0.6)),
    labelSmall: const TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w500, color: Colors.white.withOpacity(0.4)),
  );
